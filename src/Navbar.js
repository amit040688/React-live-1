...
<div className='col-lg-11 col-sm-12  mx-auto'>
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand mr-auto" to="/"><strong>React</strong> website</NavLink>
    ...
    <div className="collapse navbar-collapse custom-navbar" id="navbarSupportedContent">
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink className="nav-link " to="/services" aria-disabled="true">Services</NavLink>
        </li>
        <li className="nav-item">
